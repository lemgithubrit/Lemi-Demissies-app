...
st.markdown("<h1 style='text-align: center; color:honey;'>Engineering Properties of Ethiopian Grains Crops</h1>", unsafe_allow_html=True)
...
st.write("##")
st.write("---") 
st.sidebar.markdown("<h1 style='text-align: left; color: steelblue;'>Contact Info</h1>", unsafe_allow_html=True)
